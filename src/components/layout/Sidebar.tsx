      ...
      <div className="flex flex-col h-full bg-gradient-to-b from-sidebar to-sidebar/95">
        ...
        <div className="px-4 py-3 border-b bg-gradient-to-r from-slate-950 via-purple-950 to-slate-950">
          <div className="flex items-center gap-3">
            <div className="p-1.5 rounded-lg bg-gradient-to-br from-slate-900 to-purple-900 border border-cyan-500/30 shadow-lg shadow-cyan-500/10">
              <img src="/landing/images/ChatGPT Image 5 dic 2025, 12_17_26.png" alt="Ventify Space" className="w-8 h-8" />
            </div>
            <div className="flex-1 min-w-0">
              <span className="text-sm font-bold text-foreground block truncate">{currentCompany?.name || 'Tienda.Space'}</span>
