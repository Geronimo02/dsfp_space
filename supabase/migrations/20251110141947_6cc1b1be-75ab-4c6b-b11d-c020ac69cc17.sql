...
DROP POLICY IF EXISTS "Admins and managers can insert products in their company" ON public.products;
DROP POLICY IF EXISTS "Admins and managers can update products in their company" ON public.products;
DROP POLICY IF EXISTS "Admins can delete products from their company" ON public.products;
...
DROP POLICY IF EXISTS "Admins and managers can update customers in their company" ON public.customers;
...
DROP POLICY IF EXISTS "Users can view sales from their company" ON public.sales;
DROP POLICY IF EXISTS "Users can insert sales in their company" ON public.sales;
DROP POLICY IF EXISTS "Admins and managers can update sales in their company" ON public.sales;
DROP POLICY IF EXISTS "Admins can delete sales from their company" ON public.sales;
...
DROP POLICY IF EXISTS "Users can view quotations from their company" ON public.quotations;
DROP POLICY IF EXISTS "Users can insert quotations in their company" ON public.quotations;
DROP POLICY IF EXISTS "Admins and managers can update quotations in their company" ON public.quotations;
DROP POLICY IF EXISTS "Admins can delete quotations from their company" ON public.quotations;
